...
Использование поиска лучшей модели по сетке с использованием пайплайна привело к следующему результату: лучшей моделью стала модель SVC 
со значением гиперпараметра С равному 1. В качестве лучшего скейлера выбран StandardScaler, в качестве лучшего кодировщика OrdinalEncoder.
Значение метрики roc_auc на тестовой выборке составляет 0.92.